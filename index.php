...
<html>
    ...
    body{
        background-image: url('images/LibraryImage.webp')
...
<div class="row"><h4><?php echo $msg?></h4></div>
            <div class="row">
                ...
                <div class="col-md-6 login-form-3 text-primary ">
                    <h3 class="text-body bg-info border border-0 rounded">Admin Login</h3>
                ...
                <div class="col-md-6 login-form-1">
                    <h3 class="text-body bg-info border border-0 rounded">Student Login</h3>
